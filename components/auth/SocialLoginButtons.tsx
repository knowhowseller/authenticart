  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 h-11 rounded-xl font-medium text-sm bg-white border border-brand-mist hover:bg-brand-bg text-brand-ink transition-colors disabled:opacity-60"
      >
        {googleLoading ? (
